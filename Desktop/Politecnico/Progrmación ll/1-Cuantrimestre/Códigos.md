...
- **5️⃣ Cambia el nombre de tu rama principal a main**
    ```bash
    git branch -M main
    ```
...
# ⚠️ Advertencia: Esto eliminará todo el historial anterior. Úsalo solo si estás seguro. Haz un respaldo antes si es necesario.
